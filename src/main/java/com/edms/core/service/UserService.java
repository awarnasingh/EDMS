...
import com.edms.core.domain.Authority;
import com.edms.core.domain.User;
import com.edms.core.repository.AuthorityRepository;
import com.edms.core.repository.PersistenceAuditEventRepository;
...
import com.edms.core.service.util.RandomUtil;
import com.edms.core.web.rest.errors.EmailAlreadyUsedException;
import com.edms.core.web.rest.errors.InvalidPasswordException;
...
public class UserService {
	...
	public void updateLogoutDate(String login) {
		persistenceAuditEventRepository.updateLogoutDate(login, Instant.now());
	}
}
