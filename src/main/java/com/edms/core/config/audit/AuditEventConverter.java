package com.edms.core.config.audit;
        ...
        if (data != null) {
            for (Map.Entry<String, Object> entry : data.entrySet()) {
                ...
                if (entry.getValue() instanceof WebAuthenticationDetails) {
                    ...
                    results.put(ConstantUtils.REMOTE_ADDRESS, authenticationDetails.getRemoteAddress());
                    results.put(ConstantUtils.SESSION_ID, authenticationDetails.getSessionId());
                } else {
