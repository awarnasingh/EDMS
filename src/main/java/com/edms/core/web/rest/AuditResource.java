...
import com.edms.core.service.AuditEventService;
...
public class AuditResource {
     ...
     */
    @GetMapping(path = "/audits",params = {"fromDate", "toDate"})
    ...
    @GetMapping("/userTrans")
    public  List<PersistentAuditEvent> getTransactions(){
