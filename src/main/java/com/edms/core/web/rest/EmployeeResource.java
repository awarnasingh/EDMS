...
/**
 * REST controller for managing {@link com.edms.core.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> createEmployee(@Valid @RequestBody Employee employee) throws URISyntaxException {
        ...
        if (employee.getId() != null) {
            throw new BadRequestAlertException(ConstantUtils.EMPLOYEE_ALREADY_EXISTS, ENTITY_NAME, ConstantUtils.ID_EXISTS);
        }
        Employee result = employeeService.save(employee);
        return ResponseEntity.created(new URI(ConstantUtils.API_EMPLOYEES + result.getId()))
